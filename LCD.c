...
void LCD_Display_Name(void){
	...
	//switch display between name and name1
	unsigned char name[length] = "BRENT";
	unsigned char name1[length] = "SUCKS";

	
	while(1){

		//turn contrast to max if left is pressed
		...
		//turn contrast to min if center button is pressed
